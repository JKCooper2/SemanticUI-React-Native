...
type TypeType = 'antDesign' | 'entypo' | 'evilIcons' | 'feather' | 'fontAwesome' | 'fontAwesome5' | 'foundation' | 'ionicons' | 'materialCommunityIcons' | 'materialIcons' | 'octicons' | 'simpleLineIcons' | 'zocial'
