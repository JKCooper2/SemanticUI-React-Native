...
headerStories.add('Sub', () => <Header sub>SubHeader</Header>);

headerStories.add('Content & Subheader', () => <Header content="Header" subheader="Subheader" />);

headerStories.add('Disabled', () => <Header disabled>Header</Header>);
...
headerStories.add('Inverted', () => (
    <ScrollView style={{ backgroundColor: 'black' }}>
        <Header as="h4" color="red" inverted>
            Red
        </Header>
        ...
        <Header as="h4" color="olive" inverted>
            Olive
        </Header>
        <Header as="h4" color="green" inverted>
            Green
        </Header>
        <Header as="h4" color="teal" inverted>
            Teal
        </Header>
        <Header as="h4" color="blue" inverted>
            Blue
        </Header>
        <Header as="h4" color="purple" inverted>
            Purple
        </Header>
        <Header as="h4" color="violet" inverted>
            Violet
        </Header>
        <Header as="h4" color="pink" inverted>
            Pink
        </Header>
        <Header as="h4" color="brown" inverted>
            Brown
        </Header>
        <Header as="h4" color="grey" inverted>
            Grey
        </Header>
    </ScrollView>
));
